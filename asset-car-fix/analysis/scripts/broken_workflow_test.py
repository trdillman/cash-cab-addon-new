...
def main():
    ...
    result = {
        ...
        'validation': None,
        'test_config': {'description': 'Current workflow that breaks parenting', 'parent_clearing': True, 'expected_result': 'FAIL_PARENTING_BROKEN'}
    }
