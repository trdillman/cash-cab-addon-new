...
def main():
    ...
    result = {
        ...
        'validation': None,
        'test_config': {'description': 'Asset with no parent relationships', 'parent_clearing': True, 'expected_result': 'PASS_NO_CHANGE'}
    }
