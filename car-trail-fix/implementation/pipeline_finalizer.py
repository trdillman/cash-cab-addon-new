"""Post-pipeline clean-up helpers for BLOSM - CAR_TRAIL FIX APPLIED.
...
CAR_TRAIL FIX IMPLEMENTATION:
- Removed runtime CAR_TRAIL creation at line 2829
- Added validation logging for asset CAR_TRAIL configuration
- Asset CAR_TRAIL from ASSET_CAR.blend now handles all trail functionality
"""
...
# ... (rest of file would continue - this shows the key function is now unused)
# NOTE: _build_car_trail_from_route function is kept for compatibility but no longer called